...
public class MyCalendarTwo {
    ...
    public boolean book(final int start, final int end) {
        ...
        for (final Interval existing : overlaps) {
            if (existing.overlaps(interval)) {
                return false;
            }
        }
        
        for (final Interval cal : calendar) {
            if (cal.overlaps(interval)) {
                overlaps.add(cal.getOverlap(interval));
            }
        }
    ...
    private static class Interval {
        ...
        Interval getOverlap(final Interval interval) {
